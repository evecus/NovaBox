...
public class PlayFragment extends BaseLazyFragment {
    ...
    private void initSubtitleView() {
        ...
        if (mediaPlayer instanceof MpvMediaPlayer) {
            ...
            ((MpvMediaPlayer)mediaPlayer).loadDefaultTrack(trackInfo,progressKey);
            ((MpvMediaPlayer)mediaPlayer).setOnTimedTextListener(new MpvMediaPlayer.OnTimedTextListener() {
                @Override
