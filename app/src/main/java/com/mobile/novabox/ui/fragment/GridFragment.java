...
import com.mobile.novabox.ui.adapter.GridAdapter;
import com.mobile.novabox.ui.adapter.GridFilterKVAdapter;
import com.mobile.novabox.ui.dialog.GridFilterDialog;
import com.mobile.novabox.ui.tv.widget.LoadMoreView;
...
public class GridFragment extends BaseLazyFragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if (gridView != null && gridView.getLayoutManager() == null) {
            gridView.setLayoutManager(new LinearLayoutManager(mContext, LinearLayoutManager.VERTICAL, false));
        }
    }
...
//        if(this.focusedView != null){ this.focusedView.requestFocus(); }
    ...
    private void initView() {
        ...
        if(isFolederMode()){
            ...
            // 手机版：固定3列，与首页影视卡片保持一致；list类型保持单列
            int spanCount = com.mobile.novabox.util.PadUiHelper.getVodGridSpanCount(mContext);
