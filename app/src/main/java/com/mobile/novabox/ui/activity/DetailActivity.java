    ...
    private void openCastDialog() {
        ...
        new Thread(() -> {
            ...
            runOnUiThread(() -> {
                ...
                String castUrl = com.mobile.novabox.cast.CastUrlResolver.resolve(r.url, r.headers);
                String title = (vodInfo.name == null ? "" : vodInfo.name) + (series.name == null ? "" : " " + series.name);
                com.mobile.novabox.ui.dialog.CastSearchDialog dialog =
                        new com.mobile.novabox.ui.dialog.CastSearchDialog(DetailActivity.this, castUrl, title, null);
                dialog.show();
            });
        }).start();
    }
