...
public class BaseDialog extends Dialog {
    ...
    /**
     * 需要用 startActivityForResult 与系统交互（如 SAF 文件/目录选择器）的弹窗，
     * 应实现此接口。宿主 Activity 的 onActivityResult 会把结果转发过来。
     * Dialog 本身无法直接收到 onActivityResult 回调，必须借助宿主 Activity 转发。
     */
