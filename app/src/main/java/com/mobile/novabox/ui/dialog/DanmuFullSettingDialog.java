...
public class DanmuFullSettingDialog extends BaseDialog {
    ...
    private static final String[] ITEM_NAMES = {"地址", "开关", "颜色", "字号", "屏占比", "滚动速度", "透明"};
    ...
    private View panelApi, panelOnOff, panelColor, panelSize, panelRatio, panelSpeed, panelAlpha;
    private EditText inputApi;
    private LinearLayout llOnOffOptions, llColorOptions, llSizeOptions, llRatioOptions, llSpeedOptions, llAlphaOptions;
