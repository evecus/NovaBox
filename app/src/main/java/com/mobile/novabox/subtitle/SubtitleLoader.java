package com.mobile.novabox.subtitle;

import android.net.Uri;
import android.text.TextUtils;
import android.util.Log;

import com.mobile.novabox.subtitle.exception.FatalParsingException;
import com.mobile.novabox.subtitle.format.FormatASS;
import com.mobile.novabox.subtitle.format.FormatSRT;
import com.mobile.novabox.subtitle.format.FormatSTL;
import com.mobile.novabox.subtitle.format.TimedTextFileFormat;
import com.mobile.novabox.subtitle.model.TimedTextObject;
import com.mobile.novabox.subtitle.runtime.AppTaskExecutor;
import com.mobile.novabox.util.FileUtils;
import com.mobile.novabox.util.UnicodeReader;
